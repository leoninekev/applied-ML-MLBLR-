...
##adding preprocess function for (66,200,3)
def preprocess(image):#, angles, flip= False): #, translate= False):
...
def telemetry(sid, data):
    if data:
        ...
        try:
            ...
            print('st_angle:{}| throttle:{}|speed:{}'.format(steering_angle, throttle, speed))
